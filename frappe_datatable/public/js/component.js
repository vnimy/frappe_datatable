...
frappe.provide('frappe.DataTableComponent');

/**
 * 将frappe-datatable的部分组件暴露到frappe.DataTableComponent，
 * 如需要更多组件可以从/assets/frappe/node_modules/frappe-datatable/dist/frappe-datatable.js复制过来并导出
 */
frappe.DataTableComponent = (function () {
